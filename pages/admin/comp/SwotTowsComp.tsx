					...
					<div id="swottowsdiv" className="m_t_20">
						<div className="d_grid" style={{ gridTemplateColumns: '37% 21% 36%', gridGap: '2%' }}>
							<div className="grid_item left">
								<ul className="top">{ leftTopData.map(function(obj, idx){return <li>{obj ? obj : <b>&nbsp;</b> }</li> }) }</ul>
								<ul className="bottom">{ leftBottomData.map(function(obj, idx){return <li>{obj ? obj : <b>&nbsp;</b> }</li> }) }</ul>
							</div>
							<div className="grid_item" style={{ display: 'table' }}><h2 id="swottowscat">{nameName}</h2></div>
							<div className="grid_item right text_right">
								<ul className="top">{ rightTopData.map(function(obj, idx){return <li>{obj ? obj : <b>&nbsp;</b> }</li> }) }</ul>
								<ul className="bottom">{ rightBottomData.map(function(obj, idx){return <li>{obj ? obj : <b>&nbsp;</b> }</li> }) }</ul>
							</div>
						</div>
					</div> : ''
				}
					...
					<form onSubmit={ ( e ) => handleSubmit( e ) } action="" method="post" id="insert_form" className="m_t_30">
						{
							...
							<>
					         	<div className="d_grid" style={{ gridTemplateColumns: '23% 23% 23% 23%' , gridGap: '3%' }}>
					         		<div className="grid_item">
					         			...
					         			{ leftTopData.map(function(obj, idx){return <div className="input_m_div"><input type="text" maxLength="35" name="l_t_data[]" defaultValue={obj} placeholder="Text" /></div> }) }
					         		</div>
					         		<div className="grid_item">
					         			<div className="input_m_div"><label><b>Entry 2</b></label></div><br/>
					         			{ leftBottomData.map(function(obj, idx){return <div className="input_m_div"><input type="text" maxLength="35" name="l_b_data[]" defaultValue={obj} placeholder="Text" /></div> }) }
					         		</div>
					         		<div className="grid_item">
					         			<div className="input_m_div"><label><b>Entry 3</b></label></div><br/>
					         			{ rightTopData.map(function(obj, idx){return <div className="input_m_div"><input type="text" maxLength="35" name="r_t_data[]" defaultValue={obj} placeholder="Text" /></div> }) }
					         		</div>
					         		<div className="grid_item">
					         			<div className="input_m_div"><label><b>Entry 4</b></label></div><br/>
					         			{ rightBottomData.map(function(obj, idx){return <div className="input_m_div"><input type="text" maxLength="35" name="r_b_data[]" defaultValue={obj} placeholder="Text" /></div> }) }
					         		</div>
					         	</div>
							...
							<>
					         	<div className="d_grid" style={{ gridTemplateColumns: '23% 23% 23% 23%' , gridGap: '3%' }}>
					         		<div className="grid_item">
					         			<div className="input_m_div"><label><b>Entry 1</b></label></div><br/>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="l_t_data[]" required placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="l_t_data[]" placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="l_t_data[]" placeholder="Text" /></div>
					         		</div>
					         		<div className="grid_item">
					         			<div className="input_m_div"><label><b>Entry 2</b></label></div><br/>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="l_b_data[]" required placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="l_b_data[]" placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="l_b_data[]" placeholder="Text" /></div>
					         		</div>
					         		<div className="grid_item">
					         			<div className="input_m_div"><label><b>Entry 3</b></label></div><br/>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="r_t_data[]" required placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="r_t_data[]" placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="r_t_data[]" placeholder="Text" /></div>
					         		</div>
					         		<div className="grid_item">
					         			<div className="input_m_div"><label><b>Entry 4</b></label></div><br/>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="r_b_data[]" required placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="r_b_data[]" placeholder="Text" /></div>
					         			<div className="input_m_div"><input type="text" maxLength="35" name="r_b_data[]" placeholder="Text" /></div>
					         		</div>
					         	</div>
								<div className="input_m_div text_right m_t_20">
